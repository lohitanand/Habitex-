          ...
          <Card className="border-2 border-pixel-border">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-sm text-[hsl(var(--pixel-accent))] hover:underline">
                      Forgot password?
                    </Link>
                  </div>
            ...
            <CardFooter className="flex flex-col space-y-4 border-t border-gray-200 pt-4">
              ...
              <p className="text-center text-sm text-gray-600 mt-4">
                ...
                <Link href="/signup" className="text-[hsl(var(--pixel-accent))] hover:underline">
                  Sign up
                </Link>
              </p>
            </CardFooter>
